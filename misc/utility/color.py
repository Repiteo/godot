...
def color_print(*values: object, sep: str | None = " ", end: str | None = "\n", flush: bool = False) -> None:
    ...
    if is_stdout_color():
        ...
        print(*[RE_ANSI.sub("", str(value)) for value in values], sep=sep, end=end, flush=flush)
...
def color_printerr(*values: object, sep: str | None = " ", end: str | None = "\n", flush: bool = False) -> None:
    ...
    if is_stderr_color():
        ...
        print(*[RE_ANSI.sub("", str(value)) for value in values], sep=sep, end=end, flush=flush, file=sys.stderr)
